...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=C6hCjQrY#bWTxM86ZEI1FHl5-_eZenxfGTXHxo5J1Y4r5YW40qGM' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SESSION_NAME: process.env.SESSION_NAME === undefined ? "asitha" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , ⁨~♥️⃟ʀͥᴇᷧᴀͫʟ:| ~Nadu~🤏😎⁩ alive now!!*" : process.env.ALIVE_MSG,
